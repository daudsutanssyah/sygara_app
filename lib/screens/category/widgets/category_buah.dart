...
class CategoryBuah extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Kategori Buah-Buahan', style: AppTextStyles.h5),
      ),
      body:
          MockData.fruitProducts.isEmpty
              ? _buildEmptyState()
              : _buildProductGrid(),
    );
  }
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            'Produk buah-buahan akan segera hadir',
  ...
  Widget _buildProductGrid() {
    ...
    final products =
        MockData.fruitProducts.map((data) => Product.fromMap(data)).toList();
